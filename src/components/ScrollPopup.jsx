...
>
  <option className="text-black" value="" hidden>Select a Course*</option>
  ...
  <option className="text-black"  value="data-science">Data Science</option>
  <option  className="text-black" value="business-management">Business Management</option>
</select>
